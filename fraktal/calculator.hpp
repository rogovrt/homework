...
public:
    ...
    const auto & field() const noexcept { return m_field; }

	const auto width () const noexcept { return m_width;  }
	const auto height() const noexcept { return m_height; }

	const auto max_iterations() const noexcept { return m_max_iterations; }
